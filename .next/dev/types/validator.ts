...
// Validate ../../../app/api/user-packages/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/user-packages">> = Specific
  const handler = {} as typeof import("../../../app/api/user-packages/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
